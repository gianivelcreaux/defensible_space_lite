...
<li><input type="checkbox" id='vegetation0' name="Specimen_Garden" value="1"  onclick="UpdateCost()"><label for="Specimen_Garden">Specimen Garden	<a href="images/Specimen.jpg"  class="html5lightbox light" data-group="set1">(?)</a></label></li>
...
<p> Compare the total number to the matrix at the bottom to find out how much space you must clear around each side of your home.* </p>
<div id="result">
<h1>Matrix:</h1>
